package com.stardust.common.util;
...
import com.stardust.common.annotation.ExportConfig;
import com.stardust.common.handler.ExportHandler;
import com.stardust.common.util.poi.convert.ExportConvert;
import com.stardust.common.util.poi.pojo.ExportItem;
...
public class ExcelUtils {
	...
	private void required$BuilderParams() {
		if (mClass == null) {
			throw new IllegalArgumentException("请先使用com.stardust.util.ExcelUtils.$Builder(Class<?>)构造器初始化参数。");
		}
	}
	...
	private void required$ExportParams() {
		if (mClass == null || mResponse == null) {
			throw new IllegalArgumentException(
					"请先使用com.stardust.util.ExcelUtils.$Export(Class<?>, HttpServletResponse)构造器初始化参数。");
		}
